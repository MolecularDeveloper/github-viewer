                        ...
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <span className="label label-info">{this.props.userData.followers} Following</span>
                                    <span className="label label-danger">{this.props.userData.following} Followers</span>
                                </div>
                            </div>
                            <hr />
                            <div className="row">
